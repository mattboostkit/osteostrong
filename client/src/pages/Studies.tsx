      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <p className="mb-2 text-sm text-neutral-600">
          ...
          <li>
            ...
            Published: 29 June 2017<br/>
            <Link href="/studies/peer-reviewed/biobank-high-intensity-activity" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            Journal of Osteoporosis and Physical Activity<br/>
            Published: 28 June 2015<br/>
            <Link href="/studies/peer-reviewed/axial-bone-loading" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            Journal Of Diabetes And Metabolism<br/>
            Published: 28 April 2015<br/>
            <Link href="/studies/peer-reviewed/axial-bone-moderate-metabolic" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            © International Osteoporosis Foundation and National Osteoporosis Foundation 2015<br/>
            Published: 1 March 2015<br/>
            <Link href="/studies/peer-reviewed/wco-iofesceo-2015" className="text-primary underline">Read More</Link>
          </li>
          <li>
            <strong>Physical Activity And Bone: May The Force Be With You</strong><br/>
            Frontiers In Endocrinology<br/>
            Published: 3 March 2014<br/>
            <Link href="/studies/peer-reviewed/physical-activity-bone" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            Published: 12 April 2012<br/>
            <Link href="/studies/peer-reviewed/impact-activity-hip-bmd" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            BMB Reports<br/>
            Published: 26 February 2009<br/>
            <Link href="/studies/peer-reviewed/static-tensional-forces" className="text-primary underline">Read More</Link>
          </li>
          <li>
            <strong>Intensity Of Exercise Is Associated With Bone Density Change In Premenopausal Women</strong><br/>
            Osteoporos Int<br/>
            Published: 11 June 2006<br/>
            <Link href="/studies/peer-reviewed/exercise-bone-density" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            Osteoporos Int (2005)<br/>
            Published: 17 June 2005<br/>
            <Link href="/studies/peer-reviewed/high-impact-exercise-bmd" className="text-primary underline">Read More</Link>
          </li>
          <li>
            ...
            Published: 20 December 2000<br/>
            <Link href="/studies/peer-reviewed/load-specific-skiers" className="text-primary underline">Read More</Link>
          </li>
        </ul>
      </div>
    </section>
