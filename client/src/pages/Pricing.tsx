            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="overflow-hidden flex flex-col">
                ...
                <CardContent className="p-8 flex flex-col flex-grow">
                  ...
                  <Link href="/booknow" className="mt-auto"><Button className="bg-primary hover:bg-yellow-400 text-black font-bold py-3 px-6 rounded-full transition shadow-md w-full">Select Plan</Button></Link>
                </CardContent>
              </Card>
              {/* Silver Plan */}
              <Card className="overflow-hidden flex flex-col">
                ...
                <CardContent className="p-8 flex flex-col flex-grow">
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    <li className="flex items-start"><svg className="h-6 w-6 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><span className="text-gray-700">Weekly OsteoStrong sessions</span></li>
                    <li className="flex items-start"><svg className="h-6 w-6 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><span className="text-gray-700">Initial performance assessment</span></li>
                    <li className="flex items-start"><svg className="h-6 w-6 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><span className="text-gray-700">Monthly progress reviews</span></li>
                    <li className="flex items-start"><svg className="h-6 w-6 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><span className="text-gray-700">Quarterly wellness consultation</span></li>
              ...
              <Card className="overflow-hidden flex flex-col">
                ...
                <CardContent className="p-8 flex flex-col flex-grow">
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    ...
                    <li className="flex items-start"><svg className="h-6 w-6 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg><span className="text-gray-700">Bi-weekly progress reviews</span></li>
